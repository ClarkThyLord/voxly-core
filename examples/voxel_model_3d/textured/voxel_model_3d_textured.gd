## Example scene: textured voxel pyramid built at runtime.
##
## Rebuilds the scene by generating a fresh VoxelModel3D with three textured
## voxels (from the shared texture atlas) arranged in a stepped pyramid.
@tool
extends Node3D
...
## voxel set with three textured voxels, and fills a stepped pyramid.
